...
treats= treats[treats['morph'].str.contains('CHOLANGIOCARCINOMA', case=False, na=False)]
...
plt.title('Drug Progression in Rapid Autopsy Data of Cholangiocarcinoma Patients')
